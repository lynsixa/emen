...
// Simulación de productos y fase actual (1: Recibido, 2: Despachado, 3: Entregado)
$productos = [
    ['nombre' => 'Cerveza Artesanal', 'fase' => 1],
    ['nombre' => 'Vino Tinto', 'fase' => 2],
    ['nombre' => 'Cóctel Margarita', 'fase' => 3]
];
?>
...
<head>
  ...
  <style>
    body {
      background: linear-gradient(to bottom, #000000,rgba(255, 230, 0, 0.2)); /* negro con desvanecido amarillo */
      color: #fff;
      min-height: 100vh;
    }
        ...
        <?php if (count($productos) > 0): ?>
          <?php foreach ($productos as $producto): ?>
            <div class="mb-4 p-3 rounded" style="background-color:rgb(80, 82, 77);">
              ...
              <?php
                $fase = $producto['fase']; // 1: recibido, 2: despachado, 3: entregado
              ?>
              <div class="step">
